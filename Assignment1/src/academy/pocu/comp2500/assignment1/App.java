...
public class App {
    public App(Registry registry) {
        ...
        registry.registerCommentListGetter("Blog", "showArticleAndComment");// 블로그 글에 달린 댓글들을 가져오는 메서드를 등록한다.
        registry.registerSubcommentListGetter("Comment", "showSubComment");// 댓글에 달린 하위 댓글들을 가져오는 메서드를 등록한다.
