...
public class App {
    public App(Registry registry) {
        ...
        registry.registerPostListGetter("Blog", "showArticle");// 블로그 글 목록을 가져오는 메서드를 등록한다.
        ...
        registry.registerCommentListGetter("Article", "getArticleComment");// 블로그 글에 달린 댓글들을 가져오는 메서드를 등록한다.
